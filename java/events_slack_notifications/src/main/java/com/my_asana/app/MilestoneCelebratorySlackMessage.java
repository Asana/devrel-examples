...
public class MilestoneCelebratorySlackMessage {
    ...
    private static String CHANNEL_ID = "#asana-notifications";
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            System.out.println("Sync token expired or invalid. Saved a new sync token. Ready for future use.");
            return;
        }
